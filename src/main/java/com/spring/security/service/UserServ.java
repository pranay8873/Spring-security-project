...
public interface UserServ {
    UserResponseDto saveUser(UserSignupDto userSignupDto) throws UserNotFoundException;
    UserResponseDto login(UserLoginDto userLoginDto) throws UserNotFoundException;
    UserResponseDto updateuser(String id,UserSignupDto UserSignupDto) throws UserNotFoundException;
